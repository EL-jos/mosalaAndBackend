        ...
        <div class="el-content-area">
            <div class="el-grid el-column">
                <div class="el-container-title">
                    ...
                    <h2 class="el-title">Trouver une demande d'emploi</h2>
                </div>
                <form action="">
                    <div class="el-row">
                ...
                <div class="el-grid-jobs">
                    <a href="" class="el-offre">
                        <div class="el-container-date el-center-box">
                            <div class="el-boxImg">
                                <img src="https://source.unsplash.com/random/100×100/?$1" alt="" class="el-img">
                            </div>
                        </div>
                    ...
                    <a href="" class="el-offre">
                        <div class="el-container-date el-center-box">
                            <div class="el-boxImg">
                                <img src="https://source.unsplash.com/random/100×100/?$2" alt="" class="el-img">
                            </div>
                        </div>
                        <div class="el-content">
                            <h2 class="el-title-job el-overflow-text">Titre du job</h2>
                    ...
                    <a href="" class="el-offre">
                        <div class="el-container-date el-center-box">
                            <div class="el-boxImg">
                                <img src="https://source.unsplash.com/random/100×100/?$3" alt="" class="el-img">
                            </div>
                        </div>
                        <div class="el-content">
                            <h2 class="el-title-job el-overflow-text">Titre du job</h2>
